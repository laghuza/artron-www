...
export default function LaborTimesheetView() {
  ...
  return (
    <div className="space-y-4 font-mono text-[11px] text-[#9CA3AF]">
      {/* Banner */}
      <div className="bg-[#00ff87]/5 border border-[#00ff87]/20 p-3 rounded flex items-start gap-3">
        <AlertCircle className="w-4 h-4 text-[#00ff87] shrink-0 mt-0.5" />
      ...
      <div className="flex justify-between items-center bg-[#1A1D23] p-2 rounded border border-[#9CA3AF]/15">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1 bg-[#00ff87]/10 hover:bg-[#00ff87]/20 text-[#00ff87] border border-[#00ff87]/30 rounded uppercase cursor-pointer transition-colors"
        >
          ...
          <tbody>
            {records.map((rec) => (
              <tr key={rec.id} className="border-b border-[#9CA3AF]/10 hover:bg-[#1A1D23]/35 transition-colors">
                ...
                <td className="p-2.5 text-[#00ff87]">{rec.checkIn || "--:--:--"}</td>
                ...
                <td className="p-2.5 text-center text-[#00ff87]">{rec.overtimeHours > 0 ? `+${rec.overtimeHours}` : "0"}</td>
