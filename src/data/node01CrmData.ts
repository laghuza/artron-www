...
export const NODE_01_SUB_NODES_DATA: Record<string, Node01SubNodeDetail> = {
  ...
  '01.6': {
    subChapterId: '01.6',
    code: '01.6',
    title: 'Excel/CSV ბაზის მყისიერი მიგრაციის სიმულატორი (Live Engine)',
    card1: {
      title: '01 // ფუნქციონალური აღწერა',
      desc: 'ნებისმიერი სტრუქტურის ძველი Excel (.xlsx, .xls) ან CSV ფაილის მომენტალური წაკითხვა, სვეტების ავტომატური ამოცნობა (Auto-Mapping) და სრული იმპორტი 0.4 წამში.'
    },
    card2: {
      title: '02 // უფლებამოსილებები და უსაფრთხოება',
      desc: '100% Client-Side WASM პარსინგი | ნულოვანი სერვერული გადაცემა | AES-256 მონაცემთა შიფრაცია | სრული ლოკალური იზოლაცია.'
    },
    card3: {
      title: '03 // ბიზნეს ხედვა',
      desc: 'ნულოვანი შეფერხება სხვა პროგრამიდან Artron-ზე გადმოსვლისას (Zero-Downtime Migration), 48-საათიანი გარანტირებული ონბორდინგი და ხელით შეყვანის 100%-ით ელიმინაცია.'
    }
  }
};
