...
import { formatFedCode } from "./wizardUtils";
    ...
    <div className="space-y-4 flex-1 flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-1">
          ...
          <DiagnosticCell coordinate="[ ADM_01.4 // SPORTS_TYPE_TAGS ]" placeholder="ჭადრასკი, ფეხბურთი, რაგბი" value={sportsType} onChange={setSportsType} isValid={sportsType.trim() !== ""} />
        </div>
      </div>
