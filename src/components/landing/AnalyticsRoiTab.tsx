...
import { Users, Coins, Clock, TrendingUp, ArrowRight, Zap, Sparkles } from 'lucide-react';
...
interface AnalyticsRoiTabProps {
  t: (key: string) => string;
  locale: string;
}

export const AnalyticsRoiTab: React.FC<AnalyticsRoiTabProps> = ({ t, locale }) => {
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-cyan-950/40 via-[#05070a] to-[#0E1726] border border-cyan-500/30 shadow-[0_0_30px_rgba(0,163,255,0.1)] relative overflow-hidden backdrop-blur-xl">
            ...
            <div data-testid="roi-total-gain" className="text-3xl sm:text-4xl font-extrabold text-white font-mono tracking-tight mb-2 flex items-baseline gap-1">
              ...
              <span className="text-xs text-slate-400 font-normal font-sans ml-1">
                {locale === 'ka' ? '/ თვეში' : locale === 'ru' ? '/ мес' : '/ mo'}
              </span>
            </div>
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <RoiMetricResultCard
              ...
              suffix={locale === 'ka' ? ' სთ' : locale === 'ru' ? ' ч' : ' hrs'}
