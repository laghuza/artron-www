...
import { Phone3DMockup } from './dual-core/Phone3DMockup';
...
export const DualCoreShowcase: React.FC = () => {
  ...
  return (
    <section
      id="ecosystem"
      className="relative pt-8 sm:pt-12 pb-16 sm:pb-20 bg-[#080B10] border-t border-white/[0.06] overflow-hidden studio-grain"
    >
      {/* Ambient glows */}
      ...
      >
        {/* Section header */}
        <motion.div variants={itemVariants} className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
