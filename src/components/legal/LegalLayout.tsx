...
export const LegalLayout: React.FC<LegalLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#0B0F17] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#121b2d] via-[#0B0F17] to-[#080b11] text-white flex flex-col overflow-x-clip font-sans selection:bg-[#00A3FF]/30 selection:text-white">
