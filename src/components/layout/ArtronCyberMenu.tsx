...
export default function ArtronCyberMenu({ isMuted = false, transitionStep = "idle", onDataPurgeTrigger }: ArtronCyberMenuProps) {
  ...
  return (
    <>
      <button onClick={handleOpen} aria-label="Open Mobile Menu" className="lg:hidden fixed top-3 right-3 z-50 px-3 py-1.5 rounded-md font-mono text-[10px] font-medium tracking-widest text-[#00ff87] bg-[#05070a]/90 border border-[#8a99ad]/10 shadow-[0_0_8px_rgba(0,255,135,0.12)] backdrop-blur-md hover:bg-[#232730] uppercase flex items-center gap-1.5 cursor-pointer">
        ...
        <div className="fixed inset-0 z-[100] bg-[#121418]/95 backdrop-blur-md flex flex-col justify-between p-5 lg:hidden font-mono border-l border-[#9CA3AF]/18 overflow-y-auto animate-fadeIn select-none">
          <div className="flex justify-between items-center border-b border-[#9CA3AF]/18 pb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-[#00ff87] uppercase tracking-widest">[ ARTRON_SYS_HUD ]</span>
            </div>
            <button onClick={handleClose} className="px-2.5 py-1 text-xs text-[#9CA3AF] hover:text-[#F5F5F3] border border-[#9CA3AF]/18 rounded-sm hover:border-[#00ff87]/40 transition-colors cursor-pointer">[ X ]</button>
          </div>
          ...
          {activeTab === "about" ? (
            <div className="flex-1 flex flex-col justify-between py-4 space-y-4 animate-fadeIn">
              <div className="space-y-3 bg-[#1A1D23] border border-[#9CA3AF]/18 p-4 rounded-md">
                <div className="text-xs font-medium text-[#00ff87] uppercase tracking-wider">[ ABOUT_ARTRON_OS ]</div>
            ...
            <div className="space-y-3 my-auto py-2">
              ...
              <div className="bg-[#1A1D23] border border-[#9CA3AF]/18 p-3 rounded-md space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5 text-[10px]">
                  <span className="px-2 py-0.5 rounded-sm bg-[#00ff87]/10 text-[#00ff87] border border-[#00ff87]/30">PING 12MS</span>
              ...
              <button onClick={() => { audioManager.playClick(); setActiveTab("about"); }} className="w-full text-left bg-[#1A1D23] hover:bg-[#232730] border border-[#9CA3AF]/18 hover:border-[#00ff87]/40 p-3 rounded-md transition-colors cursor-pointer group">
                <div className="flex justify-between items-center">
                  <span className="text-[10px] text-[#6B7280] group-hover:text-[#00ff87] tracking-widest uppercase">[ ABOUT_ARTRON_OS ]</span>
              ...
              <div className="bg-[#1A1D23] border border-[#9CA3AF]/18 p-3 rounded-md space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px]">
                  {socials.map((name) => (
                    <a key={name} href="#" className="px-2 py-1.5 rounded-sm bg-[#121418] hover:bg-[#232730] text-[#9CA3AF] hover:text-[#00ff87] border border-[#9CA3AF]/18 text-center transition-colors">
                      {name}
                    </a>
                  ))}
                </div>
              ...
              <div className="bg-[#1A1D23] border border-[#9CA3AF]/18 p-3 rounded-md space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-medium">
                  <Link href="/privacy" onClick={handleClose} className="p-2 rounded-sm bg-[#121418] border border-[#9CA3AF]/18 text-[#9CA3AF] hover:text-[#00ff87] text-center truncate">PRIVACY</Link>
                  <Link href="/terms" onClick={handleClose} className="p-2 rounded-sm bg-[#121418] border border-[#9CA3AF]/18 text-[#9CA3AF] hover:text-[#00ff87] text-center truncate">TERMS</Link>
                  <Link href="/sla" onClick={handleClose} className="p-2 rounded-sm bg-[#121418] border border-[#9CA3AF]/18 text-[#9CA3AF] hover:text-[#00ff87] text-center truncate">SLA</Link>
                  <button onClick={() => { handleClose(); onDataPurgeTrigger?.(); }} className="p-2 rounded-sm bg-[#121418] border border-[#9CA3AF]/18 text-[#9CA3AF] hover:text-[#00ff87] hover:bg-[#232730] text-center truncate cursor-pointer uppercase">DATA_PURGE</button>
                </div>
              </div>
            </div>
          )}
