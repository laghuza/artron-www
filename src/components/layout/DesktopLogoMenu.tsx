    ...
    <div className="relative select-none z-50">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute top-11 right-0 z-50 w-56 bg-[#1A1D23]/90 backdrop-blur-md border border-[#9CA3AF]/18 rounded-md shadow-[0_0_8px_rgba(0,255,135,0.12)] py-2 font-mono text-xs animate-fadeIn">
            <div className="px-4 py-2 border-b border-[#9CA3AF]/18 flex items-center justify-between text-[10px] text-[#00ff87] tracking-widest uppercase">
