...
export default function MobileStageDock() {
  ...
  const activeBtn =
    "bg-[#1A1D23] text-[#00ff87] border border-[#00ff87] shadow-[0_0_8px_rgba(0,255,135,0.12)] font-medium";
  const idleBtn =
    "bg-[#121418] text-[#9CA3AF] border border-[#9CA3AF]/18 hover:text-[#F5F5F3] hover:bg-[#232730]";

  return (
    <div className="lg:hidden block fixed bottom-4 inset-x-0 mx-auto z-50 w-fit bg-[#1A1D23]/90 backdrop-blur-md border border-[#9CA3AF]/18 p-1.5 rounded-md flex gap-2 shadow-[0_0_8px_rgba(0,255,135,0.12)]">
      <button
