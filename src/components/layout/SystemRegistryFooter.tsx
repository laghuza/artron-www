        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5 font-sans text-[13px] text-silver-structure/80">
            ...
            <div className="flex gap-4 pt-1 font-mono text-[11px] text-silver-structure/45">
              <Link href="/privacy" className="hover:text-[#00ff87] underline transition-colors duration-200">[ {t("system.privacy")} ]</Link>
              <Link href="/terms" className="hover:text-[#00ff87] underline transition-colors duration-200">[ {t("system.terms")} ]</Link>
            </div>
          </div>
        </div>
