  ...
  return (
    ...
    >
      <div className={`audio-wave ${!isMuted && transitionStep !== "idle" ? "playing" : ""}`}>
        <span className="audio-bar h-1.5" style={{ backgroundColor: isMuted ? "#9CA3AF" : "#00ff87" }} />
        <span className="audio-bar h-2.5" style={{ backgroundColor: isMuted ? "#9CA3AF" : "#00ff87" }} />
        <span className="audio-bar h-2" style={{ backgroundColor: isMuted ? "#9CA3AF" : "#00ff87" }} />
      </div>
