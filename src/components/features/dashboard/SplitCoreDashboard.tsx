        ...
        <div className="absolute top-4 right-4 z-50 animate-fadeIn flex items-center gap-3">
          {onReturnToGateway && (
            <button
              ...
              className="px-3 py-1.5 bg-[#121418]/90 border border-[#00ff87]/40 text-[#00ff87] hover:bg-[#00ff87] hover:text-[#121418] text-[11px] font-mono font-bold tracking-[1.5px] uppercase rounded transition-all cursor-pointer shadow-[0_0_15px_rgba(0,255,135,0.2)]"
            >
