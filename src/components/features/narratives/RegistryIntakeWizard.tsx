      ...
      {isSuccess && (
        <div className="flex-1 flex flex-col justify-between h-full">
          <div className="space-y-4 font-mono text-xs text-[#00ff87] leading-relaxed border-t border-[#00ff87]/20 pt-4 uppercase tracking-wider">
            ...
            <div className="pt-2 font-sans text-[13px] text-silver-structure/80">გთხოვთ, შეამოწმოთ Inbox და დაასრულოთ ვერიფიკაცია.<span className="animate-pulse inline-block w-1.5 h-3.5 bg-[#00ff87] ml-1" /></div>
          </div>
