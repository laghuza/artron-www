  ...
  return (
    <div className="space-y-6 font-sans select-none animate-fadeIn">
      ...
      <p className="text-[15px] text-bone-light/85 leading-relaxed font-sans">
        {t("dashboard.default_narrative")}
      </p>

      <div className="pt-4">
        <button
          onClick={onRequestAccess}
          className="font-mono text-xs text-iron bg-emerald-core hover:bg-[#00F580] px-5 py-3 border border-emerald-core/80 rounded uppercase font-bold tracking-widest transition-all w-full text-center shadow-[0_0_15px_rgba(0,255,135,0.35),_inset_0_1px_0_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(0,255,135,0.5),_inset_0_1px_0_rgba(255,255,255,0.45)] cursor-pointer"
        >
          {t("labels.node_9")}
        </button>
      </div>
