        ...
        <div className="space-y-1">
          ...
          <div className="flex items-start gap-2 pt-2 mb-4">
            <button
              ...
              className="text-[#00ff87] hover:text-white font-mono text-xs focus:outline-none cursor-pointer mt-0.5"
            >
              {isAgreed ? '[ X ]' : '[   ]'}
            </button>
            <p className="text-[10px] text-[#9CA3AF] uppercase leading-relaxed tracking-wider">
              ...
              <Link href="/sla" target="_blank" className="text-[#00ff87] hover:underline">[SLA]</Link> {' '}
              და {' '}
              <Link href="/privacy" target="_blank" className="text-[#00ff87] hover:underline">[კონფიდენციალურობის პოლიტიკას]</Link>.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-4 pt-2 font-mono text-xs">
          ...
          <button
            ...
            className={`flex-1 py-3 px-4 font-bold border transition-all uppercase cursor-pointer ${
              isStep3Valid
                ? 'border-[#00ff87] text-[#00ff87] bg-[#00ff87]/10 hover:bg-[#00ff87] hover:text-[#121418]'
