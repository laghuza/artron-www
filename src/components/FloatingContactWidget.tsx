...
export const FloatingContactWidget: React.FC = () => {
  ...
  return (
    <div
      className={`fixed z-45 flex flex-col gap-3.5 transition-all duration-500 ease-in-out ${
        isChatbotOpen
    ...
    >
      ...
      <a
        ...
        className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[#121722]/90 text-[#25D366] shadow-lg backdrop-blur-xl transition-all duration-300 hover:scale-110 hover:border-[#25D366] hover:bg-[#25D366]/10 hover:text-[#25D366] hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#25D366]"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[#121722]/90 text-[#00A3FF] shadow-lg backdrop-blur-xl transition-all duration-300 hover:scale-110 hover:border-[#00ff87] hover:bg-[#00ff87]/10 hover:text-[#00ff87] hover:shadow-[0_0_20px_rgba(0,255,135,0.4)] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#00ff87]"
      ...
      <a
        href={phoneUrl}
        className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[#121722]/90 text-white shadow-lg backdrop-blur-xl transition-all duration-300 hover:scale-110 hover:border-[#00ff87] hover:bg-[#00ff87]/10 hover:text-[#00ff87] hover:shadow-[0_0_20px_rgba(0,255,135,0.4)] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#00ff87]"
