    ...
    <div className="absolute inset-0 pointer-events-none z-30 flex flex-col justify-between p-6 lg:p-8 animate-fadeIn">
      ...
      <div className="w-full flex items-center justify-between pointer-events-auto">
        <div
          className={`transition-all duration-500 ${
            isSubNodeSelected
              ? 'transform translate-y-0 opacity-100 bg-[#0E1015]/90 border border-[#D97736]/30 px-4 py-2.5 rounded-lg shadow-[0_0_15px_rgba(217,119,54,0.15)] backdrop-blur-md'
      ...
      {!isSubNodeSelected ? (
        ...
        <div className="my-auto w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5 pointer-events-auto animate-fadeIn">
          ...
          <div className="group bg-[#0E1015]/90 border border-amber-500/20 hover:border-[#D97736]/60 rounded-xl p-5 lg:p-6 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_0_25px_rgba(217,119,54,0.2)] transition-all duration-300 flex flex-col justify-between">
            <div>
            ...
            <div className="mt-5 pt-3 border-t border-white/5 font-mono text-[10px] text-[#D97736]/70 uppercase tracking-widest flex items-center justify-between">
              <span>TIMESHEET: VALID</span>
              <span>MOD 03.A</span>
            </div>
          </div>
