  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-30 flex flex-col justify-between p-6 lg:p-8 animate-fadeIn">
      ...
      {!isSubNodeSelected ? (
        ...
        <div className="my-auto mx-auto max-w-2xl text-center pointer-events-auto bg-[#0A0D11]/85 border border-[#00A3FF]/30 p-7 lg:p-9 rounded-2xl backdrop-blur-xl shadow-[0_12px_40px_rgba(0,0,0,0.6)] animate-fadeIn">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#00A3FF]/10 border border-[#00A3FF]/30 font-mono text-[11px] text-[#00A3FF] uppercase tracking-[0.2em] mb-4">
            <span className="w-2 h-2 rounded-full bg-[#00A3FF] animate-pulse" />
            [ NODE_07 // AI ANALYTICS & BI CORE ]
          </div>

          <h2 className="font-mono text-[22px] font-bold text-[#00A3FF] uppercase tracking-wide leading-tight mb-4 text-shadow">
            {t('node_07_analytics.title')}
          </h2>
          ...
          <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-2 font-mono text-[10px] text-gray-400">
            <div className="p-2 rounded bg-white/5 border border-white/10 text-[#00A3FF]">
              REALTIME KPI
            </div>
            <div className="p-2 rounded bg-white/5 border border-white/10 text-[#00A3FF]">
              CHURN ML (0-100%)
