...
export const NodeDetailPanel: React.FC<NodeDetailPanelProps> = ({
  ...
  return (
    <div className="w-full lg:w-[60%] bg-[#0B0C0E] p-6 lg:p-10 flex flex-col justify-between min-h-[500px] border-l border-[#262a33] overflow-y-auto select-none">
      <div className="space-y-6 max-w-xl">
        ...
        <button
          ...
          className="text-xs font-mono text-[#00E676] hover:text-white flex items-center space-x-2 uppercase tracking-wider transition-colors cursor-pointer"
        >
        ...
        <div className="space-y-2 border-b border-white/10 pb-4">
          <span className="text-xs font-mono text-[#00E676] uppercase tracking-widest flex items-center gap-2">
