          ...
          <div className="bg-[#1A1D23] border border-[#00E676]/30 p-3.5 rounded space-y-3 font-mono text-[10px]">
            ...
            <div className="grid grid-cols-2 gap-2 text-left">
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                ...
                <span className="text-[#00E676] font-medium text-[11px]">{selectedFederation.gateway.keyId}</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">ALGORITHM</span>
                <span className="text-[#00E676] font-medium text-[11px]">{selectedFederation.gateway.algorithm}</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">SYSTEM LOAD</span>
                <span className="text-[#00E676] font-medium text-[11px]">{selectedFederation.gateway.systemLoadPct}%</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">LICENSED UNTIL</span>
                <span className="text-[#00E676] font-medium text-[11px]">{selectedFederation.licensedUntil}</span>
              </div>
            </div>
          </div>
        )}
