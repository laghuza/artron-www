          ...
          <div className="bg-[#1A1D23] border border-[#00E676]/30 p-3.5 rounded space-y-3 font-mono text-[10px]">
            ...
            <div className="grid grid-cols-2 gap-2 text-left">
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                ...
                <span className="text-[#00E676] font-medium text-[12px]">{selectedAthlete.biometrics.vo2Max} mL/kg</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">TOP SPEED</span>
                <span className="text-[#00E676] font-medium text-[12px]">{selectedAthlete.biometrics.speedMs} m/s</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">FATIGUE INDEX</span>
                <span className="text-[#00E676] font-medium text-[12px]">{selectedAthlete.biometrics.fatigueScore}%</span>
              </div>
              <div className="bg-[#121418] p-2 rounded border border-[#9CA3AF]/15">
                <span className="text-[#6B7280] text-[8.5px] block">PASSKEY STATUS</span>
                <span className="text-[#00E676] font-medium text-[12px] uppercase">{selectedAthlete.passkeyStatus}</span>
              </div>
            </div>
          </div>
        )}
